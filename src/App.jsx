...
function Home({ langApi, onEdit, query }){
  ...
  return (<div>
    <div className="grid cards">
      {filtered.map(n=>(<div className="card" key={n.id} draggable onDragStart={(e)=>onDragStart(e,n.id)} onDragEnd={onDragEnd} onDrop={(e)=>onDrop(e,n.id)} onDragOver={onDragOver}>
...
function Editor({ langApi, id, onHome }){
  ...
  const [introType,setIntroType]=useState('Normal');
